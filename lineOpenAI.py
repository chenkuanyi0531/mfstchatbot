...
openai.api_key = model_list[0]['key']  
openai.api_base = model_list[0]['endpoint']  # 您的 endpoint 應該類似於 https://YOUR_RESOURCE_NAME.openai.azure.com/  
openai.api_type = 'azure'  
openai.api_version = model_list[0]['endpoint']  # 這可能會在未來變更  
...
def GPT_response(text):       
    ...
    response = openai.ChatCompletion.create(  
        engine=model_list[0]['deployment'],  
